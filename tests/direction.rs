...
fn rtl_reverses_row_order() {
    ...
    assert_eq!(world.cache.bounds(first), Some(&Rect { posx: 50.0, posy: 0.0, width: 50.0, height: 50.0 }));
    assert_eq!(world.cache.bounds(second), Some(&Rect { posx: 0.0, posy: 0.0, width: 50.0, height: 50.0 }));
}
...
fn rtl_swaps_row_padding_left_and_right() {
    ...
    assert_eq!(world.cache.bounds(child), Some(&Rect { posx: 40.0, posy: 0.0, width: 50.0, height: 50.0 }));
}
