...
fn main() {
    ...
    state.set_left(child1, Units::Stretch(1.0));
    state.set_right(child1, Units::Stretch(1.0));
    state.set_top(child1, Units::Stretch(1.0));
    state.set_bottom(child1, Units::Stretch(1.0));
