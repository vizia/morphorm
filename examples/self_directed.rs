...
fn main() {
    ...
    world.set_left(child1, Units::Stretch(1.0));
    world.set_right(child1, Units::Stretch(1.0));
    world.set_top(child1, Units::Stretch(1.0));
    world.set_bottom(child1, Units::Stretch(1.0));
